 ...
 * /api/bayar-ongkir:
 *   post:
 *     summary: Process shipping rate payment
 *     description: Handle payment processing for shipping rates and costs
 *     tags:
 *       - Payment
 *     requestBody:
 *       required: true
 ...
 * /webhook/tokobagus:
 *   post:
 *     summary: Webhook endpoint for marketplace events
 *     description: Receives webhook events from marketplace platforms for order and shipment updates
 *     tags:
 *       - Webhooks
 *     requestBody:
 *       required: true
...
/**
 * @swagger
 * /webhook/tokobagus/logs:
 *   get:
 *     summary: Get webhook event logs
 *     description: Retrieve all received webhook events for debugging and monitoring
 *     tags:
 *       - Webhooks
 *     responses:
 *       200:
